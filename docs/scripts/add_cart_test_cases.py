#!/usr/bin/env python3
"""Add Cart (Shopping Bag) module test cases to Sunny Diamonds Test Cases workbook."""
...
from cart_test_cases_data import (
    ISSUES,
    KNOWN_GAPS,
    PRECONDITIONS_LIST,
    TEST_CASES,
...
RESULTS_JSON = SCRIPT_DIR / "cart-test-results.json"

SHEET_NAME = "Cart"
ISSUES_SHEET_NAME = "Cart Issues"
MODULE = "Cart"
ROUTES = "/cart (+ global CartBagDrawer from AppProvider)"
DATA_SOURCE = "Magento GraphQL (cart quote, mutations) + localStorage line metadata + Strapi product-display benefits strip"
