#!/usr/bin/env python3
"""Add Bespoke Jewellery module test cases to Sunny Diamonds Test Cases workbook."""
...
from bespoke_test_cases_data import (
    ISSUES,
    KNOWN_GAPS,
    PRECONDITIONS_LIST,
    TEST_CASES,
...
RESULTS_JSON = SCRIPT_DIR / "bespoke-test-results.json"

SHEET_NAME = "Bespoke"
ISSUES_SHEET_NAME = "Bespoke Issues"
MODULE = "Bespoke"
ROUTES = "/bespoke-jewellery (+ /profile?section=bespoke)"
DATA_SOURCE = "Strapi CMS (contact-bespoke-page) + bespoke-submissions + customer saved-creations BFF"
