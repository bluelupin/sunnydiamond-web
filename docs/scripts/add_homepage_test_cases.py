#!/usr/bin/env python3
"""Add Homepage module test cases to Sunny Diamonds Test Cases workbook."""
...
from homepage_test_cases_data import (
    ISSUES,
    KNOWN_GAPS,
    PRECONDITIONS_LIST,
    TEST_CASES,
...
RESULTS_JSON = SCRIPT_DIR / "homepage-test-results.json"

SHEET_NAME = "Homepage"
ISSUES_SHEET_NAME = "Homepage Issues"
MODULE = "Homepage"
ROUTES = "/ (app/(site)/(home)/page.tsx)"
DATA_SOURCE = "Strapi CMS (homepage shell, editorial blocks, shopping blocks) + Magento (featured products)"
