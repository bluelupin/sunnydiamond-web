#!/usr/bin/env python3
"""Add Learn About Diamonds module test cases to Sunny Diamonds Test Cases workbook."""
...
from learn_about_diamonds_test_cases_data import (
    ISSUES,
    KNOWN_GAPS,
    PRECONDITIONS_LIST,
    TEST_CASES,
...
RESULTS_JSON = SCRIPT_DIR / "learn-about-diamonds-test-results.json"

SHEET_NAME = "Learn About Diamonds"
ISSUES_SHEET_NAME = "Learn About Diamonds Issues"
MODULE = "Learn About Diamonds"
ROUTES = "/learn-about-diamonds (/education redirects here)"
DATA_SOURCE = "Strapi CMS (learn-about-diamonds-page single type)"
