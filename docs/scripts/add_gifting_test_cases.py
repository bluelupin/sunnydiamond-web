#!/usr/bin/env python3
"""Add Gifting module test cases to Sunny Diamonds Test Cases workbook."""
...
from gifting_test_cases_data import (
    ISSUES,
    KNOWN_GAPS,
    PRECONDITIONS_LIST,
    TEST_CASES,
...
RESULTS_JSON = SCRIPT_DIR / "gifting-test-results.json"

SHEET_NAME = "Gifting"
ISSUES_SHEET_NAME = "Gifting Issues"
MODULE = "Gifting"
ROUTES = "/gifting, /gift-card (+ cart gifting panel, PDP gift marking)"
DATA_SOURCE = (
    "Strapi CMS (gifting-page) + Magento (products, facets, cart, gift card SKUs) "
    "+ BFF /api/gift-card/place-order"
)
