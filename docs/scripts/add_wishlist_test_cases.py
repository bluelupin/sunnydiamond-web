#!/usr/bin/env python3
"""Add Wishlist module test cases to Sunny Diamonds Test Cases workbook."""
...
from wishlist_test_cases_data import (
    ISSUES,
    KNOWN_GAPS,
    PRECONDITIONS_LIST,
    TEST_CASES,
...
RESULTS_JSON = SCRIPT_DIR / "wishlist-test-results.json"

SHEET_NAME = "Wishlist"
ISSUES_SHEET_NAME = "Wishlist Issues"
MODULE = "Wishlist"
ROUTES = "/wishlist (+ /profile?section=wishlist; global WishlistContext)"
DATA_SOURCE = "Magento GraphQL (customer wishlist) + localStorage sunny-wishlist + BFF /api/customer/wishlist"
