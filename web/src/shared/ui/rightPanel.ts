/** Figma desktop width for right-sliding Sheet panels. */
export const RIGHT_PANEL_WIDTH_CLASS = "max-w-472 sm:max-w-472";

/** Product detail / wishlist aside width on md+ (matches sheet panel). */
