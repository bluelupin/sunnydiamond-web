    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative mx-auto flex h-16 w-full max-w-1440 items-center justify-between px-5 md:landscape:h-[104px] md:landscape:px-10 md:landscape:py-6 2xl:max-w-1920 2xl:landscape:px-[60px]">
