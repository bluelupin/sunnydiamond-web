export const footerPages = {
  ...
  faqs: {
    title: "FAQs",
    description:
      "Find answers to the most common questions about shopping, orders, and services. The full page UI will be added here later.",
  },
  bookAnAppointment: {
  ...
  returnsAndCancellations: {
    ...
    description:
      "Review the order return and cancellation policy. The full page UI will be added here later.",
  },
  exchangeAndResizing: {
    title: "Exchange and Resizing",
    description:
      "Review exchange, resizing, and alteration details. The full page UI will be added here later.",
  },
  shippingDelivery: {
    title: "Shipping & Delivery",
    description:
      "See shipping coverage, delivery timelines, and order fulfillment details. The full page UI will be added here later.",
  },
  cashOnDeliveryPolicy: {
  ...
  termsAndConditions: {
    ...
    description:
      "Read the site terms, usage conditions, and purchasing terms. The full page UI will be added here later.",
  },
} as const;