    ...
    return (
        ...
        >
            <div className="2xl:pl-24 lg:pl-20 pl-5 lg:pr-0 pr-5">
                ...
                <div className="md:hidden h-5 w-80 bg-gray300 rounded mx-auto mb-4" aria-hidden />
            </div>
            <div className="grid grid-cols-1 gap-[14px] md:grid-cols-2 md:gap-5 lg:gap-6 items-start lg:static relative">
                ...
                <div className="relative aspect-[350/480] h-478 overflow-hidden px-5 bg-gray300/70 md:aspect-[850/600] md:h-595 md:px-0" aria-hidden />
            </div>
        </section>
    )
}
