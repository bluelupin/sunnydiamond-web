...
const OccasionsTeaserSection = ({ id }: OccasionsTeaserSectionProps) => {
  ...
  const occasionsTeaserData = editorialData?.homepage?.occasionsTeaser || editorialData?.occasionsTeaser;
  const sectionTitle = occasionsTeaserData?.sectionTitle?.trim();
  const isActive = occasionsTeaserData?.isActive === true;


  // const forYouForever = occasionsTeaserData?.bespokeForYouCards ?? null;
