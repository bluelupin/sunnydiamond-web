...
const ForYourValentineSection = ({ id }: ForYourValentineSectionProps) => {
  ...
  const isSectionVisible =
    giftingData != null &&
    giftingData.showField !== false &&
    isSectionActive(giftingData.isActive);
  ...
  return (
    <div className="lg:min-h-[750px] md:h-[600px] min-h-[700px]">
      <section
        id={id}
      ...
      >
        ...
        <div
          className={cn(
            "relative z-10 flex flex-col items-center md:flex-row h-[700px] lg:h-[750px] md:h-[600px] lg:items-center lg:justify-between lg:gap-8 lg:px-10 md:px-8 px-4 lg:pt-104 lg:pb-104 md:pt-16 md:pb-16 pt-6 pb-[112px]",
          )}
        >
          ...
          {showCutoutImage ? (
            <ScrollReveal
              delayMs={180}
              className="relative order-1 m-auto h-[336px] w-full max-w-[305px] w-full flex-1 md:order-2 md:h-[600px] md:max-w-[746px]"
            >
              <ResponsiveImage
