          ...
          {(primaryCtaUrl && primaryCtaLabel) || (secondaryCtaUrl && secondaryCtaLabel) ? (
            <Reveal direction="up" className="flex shrink-0 flex-col items-center gap-6 md:gap-8">
              {primaryCtaUrl && primaryCtaLabel ? (
                <Link
                  href={primaryCtaUrl}
                  className="btn-border-slide inline-flex h-14 items-center justify-center border-0 bg-white px-7 font-gill text-sm font-normal uppercase leading-110 text-darkblack focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0a0a0a] focus-visible:ring-offset-2"
                >
