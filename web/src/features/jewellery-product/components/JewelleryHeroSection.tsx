  ...
  return (
    ...
    >
      ...
      <h1
        ...
        className="col-start-1 row-start-1 z-10 flex w-full max-w-440 justify-center self-start justify-self-center whitespace-nowrap pt-[152px] text-center font-larken text-32 font-light leading-110 text-white md:pt-[203px] md:text-48"
      >
        {title}
      </h1>
    </section>
