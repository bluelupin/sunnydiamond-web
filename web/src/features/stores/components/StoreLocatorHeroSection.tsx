...
import { storeLocatorPageContent } from "../data/storeLocatorContent";

const StoreLocatorHeroSection = () => {
  const { hero } = storeLocatorPageContent;

  return (
    <section
      aria-labelledby="store-locator-hero-title"
