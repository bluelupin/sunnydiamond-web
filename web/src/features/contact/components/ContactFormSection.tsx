  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1140px] md:bg-gray200 md:p-6">
        ...
        <div className="mt-4 h-px w-full bg-gray50 md:hidden" aria-hidden />

        <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-4 md:mt-6 md:gap-6">
          <div className="flex flex-col gap-2">
            <label htmlFor="contact-name" className={appointmentLabelClassName}>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col gap-2">
              <label htmlFor="contact-phone" className={appointmentLabelClassName}>
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="contact-email" className={appointmentLabelClassName}>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="contact-message" className={appointmentLabelClassName}>
            ...
            <textarea
              ...
              className={cn(
                "h-[100px] w-full resize-none bg-[#F2F2F2] p-3 font-gill text-base leading-110 text-darkblack outline-none placeholder:text-[#999999]",
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                onClick={() => setConsentAccepted((current) => !current)}
                className={cn(
                  "flex size-6 shrink-0 items-center justify-center border border-darkblack bg-white",
                  consentAccepted && "border-transparent bg-linkGold",
                )}
              >
                <Check
                  className={cn(
                    "size-4 text-white transition-opacity",
                    consentAccepted ? "opacity-100" : "opacity-0",
                  )}
                  strokeWidth={2.5}
                  aria-hidden
                />
              </button>
              <p className="hidden font-gill text-base font-light leading-110 text-darkblack md:block">
                {form.consentPrefix}{" "}
              ...
              <p className="font-gill text-sm font-light leading-110 text-neutral500 md:hidden">
                {form.consentPrefix}{" "}
                <Link
          ...
          <button
            ...
            className="btn-dark-slide inline-flex h-14 w-full items-center justify-center border border-darkblack px-7 font-gill text-sm uppercase leading-110 text-white disabled:cursor-not-allowed disabled:border-neutral500 disabled:bg-neutral500 disabled:opacity-50 md:w-auto md:self-start"
          >
