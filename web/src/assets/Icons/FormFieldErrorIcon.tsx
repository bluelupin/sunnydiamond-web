type FormFieldErrorIconProps = {
  className?: string;
};

/** Figma 2556:26734 — form field error icon */
const FormFieldErrorIcon = ({ className }: FormFieldErrorIconProps) => (
  <svg
    width="24"
    height="24"
...
export default FormFieldErrorIcon;
