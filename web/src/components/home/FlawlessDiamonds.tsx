...
import flawlessDiamond from "@/assets/flawless-diamond-transparent.webp";
import diamondGif from "@/assets/diamond-gif.gif";

const FlawlessDiamonds = ({ id }: { id?: string }) => {
  const ref = useFadeIn();
  ...
  return (
    ...
    >
      ...
      <div className="relative container h-full py-12 md:py-16 flex flex-col items-center justify-center text-center">
        <img src={getImageSrc(diamondGif)} alt="Diamond Gif Icon" className="w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 opacity-80" />
        <h2 className="mt-6 lg:text-5xl md:text-4xl text-32 font-light text-darkblack font-larken max-w-2xl leading-tight tracking-[0%]">
          Internally flawless diamonds, sourced from Belgium
        </h2>
...
export default FlawlessDiamonds;
